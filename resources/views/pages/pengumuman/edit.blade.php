...
<li class="breadcrumb-item fw-bold">Edit Data</li>
@endsection
...
<div class="row my-4">
    <div class="col-12">
        <div class="card border-0 shadow-sm rounded-3">
            ...
            <div class="card-body">
                <form action="{{ route('admin.pengumuman.update', $pengumuman->id) }}" method="POST" id="formPengumuman">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="keterangan" id="editor">{{ old('keterangan', $pengumuman->keterangan) }}</textarea>
                    </div>
